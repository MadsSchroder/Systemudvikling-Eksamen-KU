...
from ToXML import CoursesToXml
...
if __name__ == "__main__":
    ...
    cursor = db.cursor()
    query = (
        "SELECT classes.id, classes.location, classes.date, classes.start, classes.end, classes.courseid, courses.course FROM s206007.classes JOIN s206007.courses WHERE classes.courseid = courses.courseID")
